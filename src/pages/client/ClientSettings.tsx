...
import { User, Mail, Phone, MapPin, Calendar, FileText, Lock, Save, Loader2 } from "lucide-react";
                ...
                <form onSubmit={handleProfileUpdate} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Tell us about yourself, your case requirements, or any relevant information..."
                      rows={4}
                    />
                  </div>
